...
export default function JobsHero() {
  ...
  const handleSearch = (e: React.FormEvent) => {
    e.preventDefault()
    console.log("Searching for:", { keyword, location, company })
    ...
    <section className="relative min-h-[600px] h-[75vh] flex items-center justify-center overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative z-10 text-center">
        <div className="flex flex-col items-center justify-center">
          <h1 className="text-4xl md:text-5xl font-bold text-white mb-4 leading-tight">Find a Job</h1>
          <p className="text-xl text-white/90 mb-8 max-w-3xl mx-auto">
            Explore a wide range of healthcare job opportunities to empower your career.
          </p>
